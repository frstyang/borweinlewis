...
at that point, $h(x) := \delta g(x) + \frac{1-\delta}{\delta}f(u) 
= f(\delta x + (1-\delta)u)$ is continuous at $y$. Notice that 
$h(\frac{x - (1-\delta)}{\delta}) = f(x)$. Since $h$ is continuous 
at $y$ and $\frac{\cdot - (1-\delta)}{\delta}$ is continuous everywhere,
